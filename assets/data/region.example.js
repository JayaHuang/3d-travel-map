...
window.RG_CONFIG = {
  ...
  // 河流样式 {w:宽度, c:颜色, o:不透明度, y:抬高}；未列出的河流用默认样式
  riverStyles: {
    '黄河':   { w: 0.62, c: 0xd9a441, o: 0.92, y: 0.10 },
    '汾河':   { w: 0.34, c: 0x4fb8e8, o: 0.85, y: 0.09 },
    '桑干河': { w: 0.20, c: 0x58c8dd, o: 0.62, y: 0.08 },
    '漳河':   { w: 0.20, c: 0x58c8dd, o: 0.62, y: 0.08 },
    '沁河':   { w: 0.20, c: 0x58c8dd, o: 0.62, y: 0.08 },
    '涑水河': { w: 0.18, c: 0x58c8dd, o: 0.55, y: 0.08 }
  },
